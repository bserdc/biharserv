import { School, FormConfig, Student, NoticeCircular, MeritTopper, GrievanceTicket } from '../types';
...
export const INITIAL_STUDENTS: Student[] = [
  {
    ...
    result_details: {
      ...
      subject_breakup: [
        ...
        { subject: 'Mental Ability & Reasoning', marks: 19, max_marks: 20 },
        { subject: 'General Knowledge & Current Affairs', marks: 14, max_marks: 20 }
      ]
    },
  ...
  },
  {
    ...
    personal_data: {
      name: 'Pooja Kumari',
      father_name: 'Manoj Prasad',
      dob: '2008-04-12',
      mobile: '9835123456',
      email: 'pooja.prasad@example.com',
      photo_url: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=300&h=300&fit=crop&crop=faces',
      gender: 'Female',
      category: 'General',
      address: 'Shivaji Chowk, Singheshwar, Madhepura, Bihar - 852128',
      custom_responses: {
        'Aadhaar Number': '4412-8871-3392',
    ...
    school_data: {
      ...
      panchayat: 'Singheshwar Ward 02',
      current_class: '10th',
      previous_year_percentage: 91.2
    },
    payment_info: {
      status: 'PAID',
      amount: 50,
      txn_id: 'TXN_99887713',
      order_id: 'ORDER_BSEDRC_8942',
      paid_at: '2026-08-11 11:20:00',
      payment_mode: 'QR_SCAN'
    },
    documents: {
      application_form_pdf: '/docs/form_BSEDRC-2026-8942.pdf',
      admit_card_pdf: '/docs/admit_BSEDRC-2026-8942.pdf',
      marksheet_pdf: '/docs/result_BSEDRC-2026-8942.pdf'
    },
    exam_details: {
      roll_no: '100246',
      exam_center: 'Project Girls High School Center 2, Singheshwar',
      exam_datetime: '2026-09-15 10:00 AM',
      reporting_time: '09:15 AM',
      room_no: 'Room 202'
    },
    result_details: {
      ...
      rank: 1,
      subject_breakup: [
        { subject: 'Mathematics', marks: 29, max_marks: 30 },
        { subject: 'General Science', marks: 30, max_marks: 30 },
        { subject: 'Mental Ability & Reasoning', marks: 20, max_marks: 20 },
  ...
  {
    _id: 'std_3',
    registration_id: 'BSEDRC-2026-8943',
    form_id: 'EXAM_2026_01',
    personal_data: {
      ...
      custom_responses: {
        'Aadhaar Number': '6678-2234-9910',
        'Mother Name': 'Radha Devi',
        'Medium of Examination': 'Hindi'
      }
    },
    school_data: {
      ...
      panchayat: 'Ward 12',
      current_class: '9th',
      previous_year_percentage: 78.0
    },
    payment_info: {
      status: 'PAID',
      amount: 50,
      txn_id: 'TXN_99887714',
      order_id: 'ORDER_BSEDRC_8943',
      paid_at: '2026-08-12 16:45:00',
      payment_mode: 'DEBIT_CARD'
    },
    documents: {
      application_form_pdf: '/docs/form_BSEDRC-2026-8943.pdf',
      admit_card_pdf: '/docs/admit_BSEDRC-2026-8943.pdf',
      marksheet_pdf: '/docs/result_BSEDRC-2026-8943.pdf'
    },
    exam_details: {
      roll_no: '100247',
      exam_center: 'Patna Collegiate Main Hall, Bankipore',
      exam_datetime: '2026-09-15 10:00 AM',
      reporting_time: '09:15 AM',
      room_no: 'Room 305'
    },
    result_details: {
      ...
      rank: 18,
      subject_breakup: [
        { subject: 'Mathematics', marks: 22, max_marks: 30 },
        { subject: 'General Science', marks: 23, max_marks: 30 },
        { subject: 'Mental Ability & Reasoning', marks: 15, max_marks: 20 },
        { subject: 'General Knowledge & Current Affairs', marks: 12, max_marks: 20 }
      ]
    },
  ...
  },
  {
    ...
    personal_data: {
      ...
      custom_responses: {
        'Aadhaar Number': '9901-4432-1189',
        'Mother Name': 'Meena Devi',
        'Medium of Examination': 'Hindi'
      }
    },
    school_data: {
      ...
      panchayat: 'Kahalgaon',
      current_class: '10th',
      previous_year_percentage: 86.4
    },
    payment_info: {
      status: 'PAID',
      amount: 50,
      txn_id: 'TXN_99887715',
      order_id: 'ORDER_BSEDRC_8944',
      paid_at: '2026-08-14 09:15:00',
      payment_mode: 'UPI'
    },
    documents: {
      application_form_pdf: '/docs/form_BSEDRC-2026-8944.pdf',
      admit_card_pdf: '/docs/admit_BSEDRC-2026-8944.pdf',
      marksheet_pdf: '/docs/result_BSEDRC-2026-8944.pdf'
    },
    exam_details: {
      roll_no: '100248',
      exam_center: 'Zila School Hall B, Saharsa Sadar',
      exam_datetime: '2026-09-15 10:00 AM',
      reporting_time: '09:15 AM',
      room_no: 'Room 12'
    },
    result_details: {
      ...
      subject_breakup: [
        { subject: 'Mathematics', marks: 29, max_marks: 30 },
        { subject: 'General Science', marks: 28, max_marks: 30 },
        { subject: 'Mental Ability & Reasoning', marks: 18, max_marks: 20 },
        { subject: 'General Knowledge & Current Affairs', marks: 16, max_marks: 20 }
      ]
    },
  ...
  },
  {
    ...
    personal_data: {
      ...
      father_name: 'Pramod Yadav',
      dob: '2007-12-30',
      mobile: '9934112233',
      photo_url: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=300&fit=crop&crop=faces',
      gender: 'Male',
      category: 'OBC',
      address: 'Main Market, Shankarpur, Madhepura, Bihar',
      custom_responses: {
        'Aadhaar Number': '5512-9901-7782',
    ...
    school_data: {
      ...
      panchayat: 'Jirwa',
      current_class: '8th',
      previous_year_percentage: 67.5
    },
    payment_info: {
      status: 'PAID',
      amount: 50,
      txn_id: 'TXN_99887716',
      order_id: 'ORDER_BSEDRC_8945',
      paid_at: '2026-08-15 17:00:00',
      payment_mode: 'UPI'
    },
    documents: {
      application_form_pdf: '/docs/form_BSEDRC-2026-8945.pdf',
      admit_card_pdf: '/docs/admit_BSEDRC-2026-8945.pdf',
      marksheet_pdf: '/docs/result_BSEDRC-2026-8945.pdf'
    },
    exam_details: {
      roll_no: '100249',
      exam_center: 'Govt High School Hall A, Main Road Madhepura',
    ...
    result_details: {
      ...
      rank: 29,
      subject_breakup: [
        { subject: 'Mathematics', marks: 19, max_marks: 30 },
        { subject: 'General Science', marks: 21, max_marks: 30 },
        { subject: 'Mental Ability & Reasoning', marks: 13, max_marks: 20 },
        { subject: 'General Knowledge & Current Affairs', marks: 11, max_marks: 20 }
      ]
    },
