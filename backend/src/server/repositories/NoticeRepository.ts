...
import { NoticeCircular } from '../../types';

export class NoticeRepository {
  /**
   * Find all published, non-expired notices (public endpoint)
   */
  ...
  /**
   * Find all notices (admin only) - includes published, unpublished, and expired
   */
