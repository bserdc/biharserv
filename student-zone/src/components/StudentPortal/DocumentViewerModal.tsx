              ...
              <div>
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-300 mb-6 flex justify-between items-center text-xs">
                  ...
                  <div>
                    ...
                    <span className="inline-block px-2 py-0.5 bg-emerald-100 text-emerald-800 rounded font-bold text-[11px]">
                      PAID / JAMA HO GAYA (₹{student.payment_info.amount}) • {student.payment_info.txn_id}
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 mb-6">
                    ...
                    <table className="w-full text-xs text-left border-collapse">
                      <tbody>
                        ...
                        <tr className="border-b border-slate-200">
                          ...
                          <td className="py-2 text-slate-900 font-mono">{student.personal_data.mobile}</td>
                        </tr>
                        <tr className="border-b border-slate-200">
                        ...
                        <tr className="border-b border-slate-200">
                          ...
                          <td className="py-2 text-slate-800">{student.personal_data.address || 'Bihar, India'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div className="sm:col-span-1 flex flex-col items-center">
                    ...
                    />
                    <span className="text-[10px] text-slate-500 mt-1 font-mono">{student.personal_data.mobile}</span>
                  </div>
                </div>
                ...
                <div className="p-3 bg-emerald-50 rounded border border-emerald-300 text-xs text-emerald-900 flex items-center justify-between mb-6">
                  <div>
                    ...
                    <span>Txn ID: {student.payment_info.txn_id} • Rashi: ₹{student.payment_info.amount} ({student.payment_info.payment_mode || 'UPI'})</span>
                  </div>
                  <span className="font-mono text-[11px] text-emerald-800">{student.payment_info.paid_at}</span>
                </div>
              </div>
            )}
