...
export const StudentStatusTracker: React.FC<StudentStatusTrackerProps> = ({
  ...
  useEffect(() => {
    if (initialRegId) {
      ...
      performSearch(initialRegId, '');
    } else {
      performSearch('BSEDRC-2026-8941', '');
    }
  }, [initialRegId]);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="p-4 rounded-xl border-2 border-emerald-500 bg-emerald-50/50 flex flex-col justify-between">
                <div>
                  ...
                  <h4 className="font-bold text-slate-900 text-xs">Fees Jama: ₹{studentData.payment_info.amount}</h4>
                  <p className="text-[11px] text-slate-600 mt-1 font-mono">
                    Txn ID: {studentData.payment_info.txn_id}
                  </p>
                </div>
